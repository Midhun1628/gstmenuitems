...
<template>
  <div v-if="!emailDetails">
    ...
    <!---Mail Listing Table-->
    <v-table class="mt-3 mailTable bordered-table" v-if="filteredMails.length > 0">
      <tbody>
        <tr
    ...
    <!---If no mail-->
    <div v-else class="text-center pa-3 d-flex justify-center align-center" style="min-height: 580px">
      <div>
